...
BEGIN
    ...
    EXECUTE IMMEDIATE 'GRANT CREATE SESSION, ALTER SESSION TO ' || v_user;
    EXECUTE IMMEDIATE 'GRANT SELECT ANY TRANSACTION, FLASHBACK ANY TABLE TO ' || v_user;
    EXECUTE IMMEDIATE 'GRANT SELECT ANY DICTIONARY TO ' || v_user;
    EXECUTE IMMEDIATE 'GRANT EXECUTE_CATALOG_ROLE TO ' || v_user;
    EXECUTE IMMEDIATE 'GRANT RESOURCE TO ' || v_user;
    EXECUTE IMMEDIATE 'GRANT DBA TO ' || v_user;
