...
BEGIN
    ...
    IF v_count = 0 THEN
        EXECUTE IMMEDIATE 'CREATE USER &2 IDENTIFIED BY &3 DEFAULT TABLESPACE users TEMPORARY TABLESPACE temp QUOTA UNLIMITED ON users';

        -- Required privileges
        EXECUTE IMMEDIATE 'GRANT CREATE SESSION TO &2';
        EXECUTE IMMEDIATE 'GRANT CREATE TABLE, CREATE VIEW, CREATE SEQUENCE TO &2';
        ...
        -- GoldenGate-specific admin privilege
